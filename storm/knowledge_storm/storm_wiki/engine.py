...
class STORMWikiLMConfigs(LMConfigs):
    ...
    def init_groq_model(
        self,
        groq_api_key: str,
        api_base: str = "https://api.groq.com/openai/v1",  # default Groq endpoint
        ...
        # Replace every component with Groq model
        self.conv_simulator_lm = LitellmModel(
            model="groq/llama3-8b-8192", max_tokens=30, **groq_args
        )
